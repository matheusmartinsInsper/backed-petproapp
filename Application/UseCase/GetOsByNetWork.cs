...
namespace app.Application.UseCase
{
    public class GetOsByNetWork
    {
        ...
        public GetOsByNetWork(IRepositoryUserCollaborator repocollaborator, IRepositoryUserClinic repoclinic, IRepositoryOrderService repoorder, IRepositoryService reposervice, IRepositoryPet repopet, IRepositoryUserTutor repotutor)
        {
        ...
        {
            List<OrderService> orders = await _repoorder.getByNetWork(iduser, wasaccepted);
