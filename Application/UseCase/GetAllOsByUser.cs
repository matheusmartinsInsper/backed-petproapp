...
namespace app.Application.UseCase
{
    public class GetAllOsByUser
    {
        ...
        public GetAllOsByUser(IRepositoryUserCollaborator repocollaborator, IRepositoryUserClinic repoclinic, IRepositoryOrderService repoorder, IRepositoryService reposervice, IRepositoryPet repopet, IRepositoryUserTutor repotutor)
        {
        ...
        {
            List<OrderService> ordersaccepted = await _repoorder.getByUser(iduser, true);
            List<OrderService> ordersnotaccepted = await _repoorder.getByUser(iduser, false);
